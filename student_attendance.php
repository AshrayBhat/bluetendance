...
echo nl2br("CN2:".$row['Computer Networks 2']."\n\r");
echo nl2br("SE:".$row['Software Engineering']."\n\r");
echo nl2br("Web T:".$row['Web Technology']."\n\r");
echo nl2br("Unix:".$row['Unix']."\n\r");
echo nl2br("Elective:".$row['Elective']."\n\r");
